...
module.exports = {
  ...
  meta: [    	//Apple home screen app fullscreen
    ...
    { name: "application-name", content: "Angular 2 Composer Starter" },
    { name: "msapplication-tooltip", content: "Angular 2 Composer Starter" },
    { name: "msapplication-starturl", content: "./" },
    { name: "msapplication-navbutton-color", content: "#B71C1C" },
    { name: "msapplication-TileColor", content: "#B71C1C" },
